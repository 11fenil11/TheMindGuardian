...
object UsageStats {
    ...
    fun queryUsageStats(context: Context, startDate: Long, endDate: Long): ArrayList<Map<String, String>> {
        ...
        for (usage in usageStats) {
            var u: Map<String, String> = mapOf(
//                    "eventType" to usage.eventType.toString(),
...
////-------------------------Change-------------------------------------------
//    fun queryEventUsageInfoMap(context: Context, startDate: Long, endDate: Long): Map<String, Map<String, String>> {
//        var usm = context.getSystemService(Context.USAGE_STATS_SERVICE) as UsageStatsManager
//        var usageStats = usm.queryEventUsageInfoMap(startDate, endDate)
//
...
//                    "eventType" to packageUsage?.eventType.toString(),
